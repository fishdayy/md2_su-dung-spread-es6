...
var Newspaper = /** @class */ (function (_super) {
    ...
    function Newspaper(id, imprint, releaseNumber, releaseDay) {
        var _this = _super.call(this, id, imprint, releaseNumber) || this;
        _this._releaseDay = releaseDay;
        return _this;
    }
    Object.defineProperty(Newspaper.prototype, "releaseDay", {
        get: function () {
            return this._releaseDay;
        },
        set: function (releaseDay) {
